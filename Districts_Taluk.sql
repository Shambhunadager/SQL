...
insert into  districts_info values('Shimoga',9,9,145638,4823,'joga',58176);
...
insert into taluk_info values('Haveri',5,1,85643,4586,25);
insert into taluk_info values('Ranebenuru',3,2,53461,2314,12);
insert into taluk_info values('Byadgi',1,3,56874,13256,11);
insert into taluk_info values('Rattihalli',3,4,25643,8686,15);
insert into taluk_info values('Hirakeruru',4,5,56472,7893,18);
insert into taluk_info values('Hangal',3,5,24565,4562,11);
insert into taluk_info values('Hosabavi',1,6,42062,5834,18);
insert into taluk_info values('Shigav',2,7,36301,2453,19);
insert into taluk_info values('Masuru',1,8,14512,4863,12);
insert into taluk_info values('halageri',4,9,34445,1524,17);
